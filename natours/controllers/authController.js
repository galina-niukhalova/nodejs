...
const createAndSentToken = (user, statusCode, resp, req) => {
...
exports.signup = catchAsync(async (req, resp) => {
  ...
  createAndSentToken(newUser, 201, resp, resp);
});
...
exports.login = catchAsync(async (req, resp, next) => {
  ...
  createAndSentToken(user, 200, resp, req);
});
