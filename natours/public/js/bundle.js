...
exports.default = exports.updateSettings = void 0;
...
var updateSettings = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var data, type, url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            data = _ref.data, type = _ref.type;
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your data is successfully updated');
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
...
exports.default = exports.displayMap = void 0;
...
exports.default = exports.bookTour = void 0;
...
var stripe = Stripe("pk_test_KqTxQwCWAQWtovM2ouGu4KG200bITGGdt9");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:8000/api/v1/booking/checkout-session/".concat(id));
